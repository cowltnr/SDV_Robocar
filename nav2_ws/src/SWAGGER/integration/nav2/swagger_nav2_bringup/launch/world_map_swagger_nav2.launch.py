...
def generate_launch_description():
    ...
    declare_map_file_cmd = DeclareLaunchArgument(
        "map_file",
        default_value="/home/cowltnr/map/world_map.png",
        description="Map file path",
    )
    declare_map_yaml_cmd = DeclareLaunchArgument(
        "map_yaml",
        default_value="/home/cowltnr/map/world_map.yaml",
    ...
    declare_swagger_planner_config_cmd = DeclareLaunchArgument(
        ...
        default_value="/home/cowltnr/nav2_ws/src/SWAGGER/integration/nav2/swagger_nav2_bringup/params/world_map_swagger_nav2.yaml",
